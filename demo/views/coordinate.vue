  ...
  methods: {
    onClick (e) {
      if (this.enabled) {
        ...
        this.$refs.guide.open(e.clientX, e.clientY)
      }
...
<style lang="stylus">
.theme--light.application.coordinate
